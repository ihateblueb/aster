<!--
	This component is a modified version of a fork of https://github.com/sveltejs/svelte-virtual-list
	The fork of the component is https://github.com/gitbreaker222/svelte-virtual-list
	It's license is available here: https://github.com/sveltejs/svelte-virtual-list/blob/master/LICENSE
-->
...
<script>
	...
	async function handle_scroll() {
		...
		console.debug(
			'[VirtualList] ' + start + '-' + end + ' of ' + items.length
		);
	}
