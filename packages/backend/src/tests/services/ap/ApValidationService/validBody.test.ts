...
let apvb1 = ApValidationService.validBody(undefined);
let apvb2 = ApValidationService.validBody({});
let apvb3 = ApValidationService.validBody({
    id: 'not a url',
});
let apvb4 = ApValidationService.validBody({
    id: 'https://example.com/notes/1',
});
let apvb5 = ApValidationService.validBody({
    id: 'https://example.com/notes/1',
    type: 'Note'
});
