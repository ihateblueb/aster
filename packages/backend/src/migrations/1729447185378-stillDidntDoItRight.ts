...
export class StillDidntDoItRight1729447185378 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "drive_file" ALTER COLUMN "userId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "relationship" DROP CONSTRAINT "FK_9547682b151a8d9ee40039aaea3"`);
        await queryRunner.query(`ALTER TABLE "relationship" ALTER COLUMN "responseActivityId" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "activity" DROP CONSTRAINT "FK_4ec8340b89b02ddf342e770e4ec"`);
        await queryRunner.query(`ALTER TABLE "drive_file" DROP CONSTRAINT "FK_860fa6f6c7df5bb887249fba22e"`);
        await queryRunner.query(`ALTER TABLE "relationship" ALTER COLUMN "responseActivityId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "relationship" ADD CONSTRAINT "FK_9547682b151a8d9ee40039aaea3" FOREIGN KEY ("responseActivityId") REFERENCES "activity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "drive_file" ALTER COLUMN "userId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "drive_file" ADD CONSTRAINT "FK_860fa6f6c7df5bb887249fba22e" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "note_like" DROP COLUMN "Emoji"`);
        await queryRunner.query(`ALTER TABLE "note_like" DROP COLUMN "emojiId"`);
        await queryRunner.query(`ALTER TABLE "activity" DROP COLUMN "content"`);
