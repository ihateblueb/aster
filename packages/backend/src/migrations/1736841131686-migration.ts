...
export class Migration1736841131686 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "note_attachments" RENAME COLUMN "noteId" TO "attachmentIds"`
		);
		await queryRunner.query(
			`ALTER TABLE "note_attachments" RENAME CONSTRAINT "PK_24d1170576078dd6efd984b22e1" TO "PK_455c6b7067dab24345b8d50bc21"`
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "note_attachments" RENAME CONSTRAINT "PK_455c6b7067dab24345b8d50bc21" TO "PK_24d1170576078dd6efd984b22e1"`
		);
		await queryRunner.query(
			`ALTER TABLE "note_attachments" RENAME COLUMN "attachmentIds" TO "noteId"`
		);
		await queryRunner.query(
