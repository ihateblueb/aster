...
export class Init1728419607231 implements MigrationInterface {
    name = 'Init1728419607231'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "user" character varying NOT NULL, "password" character varying NOT NULL, "privateKey" character varying NOT NULL, CONSTRAINT "UQ_9ec886924bcd97ae6f14220017a" UNIQUE ("user"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "user" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "UQ_9ec886924bcd97ae6f14220017a" UNIQUE ("user")`);
        await queryRunner.query(`ALTER TABLE "user" ADD "password" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "privateKey" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "apId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "UQ_98c3361fca2f1f3f737da4ed443" UNIQUE ("apId")`);
        await queryRunner.query(`ALTER TABLE "user" ADD "inbox" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "outbox" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "username" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "displayName" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "host" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "local" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "user" ADD "locked" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "discoverable" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "user" ADD "indexable" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "user" ADD "automated" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "speakAsCat" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "user" ADD "avatar" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "banner" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "background" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD "createdAt" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "updatedAt" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "followingUrl" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "followersUrl" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ADD "admin" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "user" ADD "publicKey" character varying NOT NULL`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "followersUrl"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "followingUrl"`);
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "discoverable"`);
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "UQ_98c3361fca2f1f3f737da4ed443"`);
