...
export class Migration1736844346045 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "FK_59cf146e9e8cf2dd161a6eed8b0"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_59cf146e9e8cf2dd161a6eed8b"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_649ac05af65c8e062274ec29b9f"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_59cf146e9e8cf2dd161a6eed8b0" PRIMARY KEY ("driveFileIds")`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP COLUMN "attachmentIds"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_59cf146e9e8cf2dd161a6eed8b0"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP COLUMN "driveFileIds"`);
        await queryRunner.query(`ALTER TABLE "drive_file" ADD "noteIds" character varying array`);
        ...
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD "noteId" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_dd60d4adc8e73b7ae339ba9beb1"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_24d1170576078dd6efd984b22e1" PRIMARY KEY ("driveFileId", "noteId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_24d1170576078dd6efd984b22e1"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_dd60d4adc8e73b7ae339ba9beb1" PRIMARY KEY ("driveFileId")`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP COLUMN "noteId"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_dd60d4adc8e73b7ae339ba9beb1"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP COLUMN "driveFileId"`);
        await queryRunner.query(`ALTER TABLE "drive_file" DROP COLUMN "noteIds"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD "driveFileIds" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_59cf146e9e8cf2dd161a6eed8b0" PRIMARY KEY ("driveFileIds")`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD "attachmentIds" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_59cf146e9e8cf2dd161a6eed8b0"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_649ac05af65c8e062274ec29b9f" PRIMARY KEY ("attachmentIds", "driveFileIds")`);
        await queryRunner.query(`CREATE INDEX "IDX_59cf146e9e8cf2dd161a6eed8b" ON "note_attachments" ("driveFileIds") `);
        ...
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "FK_59cf146e9e8cf2dd161a6eed8b0" FOREIGN KEY ("driveFileIds") REFERENCES "drive_file"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
