...
export class Migration1730183862706 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "note_react" ("id" character varying NOT NULL, "userId" character varying NOT NULL, "emojiId" character varying NOT NULL, "noteId" character varying NOT NULL, "createdAt" character varying NOT NULL, "Emoji" character varying, CONSTRAINT "REL_0661edae8befa45f9e12d16e20" UNIQUE ("noteId"), CONSTRAINT "PK_4f10b40fa455ab13ab338508237" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
