...
export class AddAuth1728428625322 implements MigrationInterface {
	name = 'AddAuth1728428625322';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "auth" ("id" character varying NOT NULL, "user" character varying NOT NULL, "created_at" character varying NOT NULL, "token" character varying NOT NULL, CONSTRAINT "UQ_f4aae9866cf436c5fb567f0d599" UNIQUE ("token"), CONSTRAINT "PK_7e416cf6172bc5aec04244f6459" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
