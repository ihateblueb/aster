...
export class Migration1736841632095 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_455c6b7067dab24345b8d50bc21"`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_ef2f26e3b95aba28ee1a2f18dfb" PRIMARY KEY ("attachmentIds_1")`
		);
		await queryRunner.query(
			`ALTER TABLE "note_attachments" ADD "attachmentIds_2" character varying NOT NULL`
		);
		await queryRunner.query(
			`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_ef2f26e3b95aba28ee1a2f18dfb"`
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_455c6b7067dab24345b8d50bc21" PRIMARY KEY ("attachmentIds", "driveFileId")`
		);
		await queryRunner.query(
