...
export class Migration1736841848791 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_0c8a7a2aacde26464cd1cd83f78" PRIMARY KEY ("attachmentIds_2")`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP COLUMN "attachmentIds_1"`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_0c8a7a2aacde26464cd1cd83f78"`);
        ...
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD CONSTRAINT "PK_048e86f11925d47f8895c381d43" PRIMARY KEY ("attachmentIds")`);
        await queryRunner.query(`ALTER TABLE "note_attachments" ADD "driveFileIds" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "note_attachments" DROP CONSTRAINT "PK_048e86f11925d47f8895c381d43"`);
