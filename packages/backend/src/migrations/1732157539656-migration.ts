...
export class Migration1732157539656 implements MigrationInterface {
    name = 'Migration1732157539656'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "note_like" DROP CONSTRAINT "FK_8dc185ad3ae7fc6e49dbf66abef"`);
        await queryRunner.query(`ALTER TABLE "note_like" DROP CONSTRAINT "REL_8dc185ad3ae7fc6e49dbf66abe"`);
        await queryRunner.query(`ALTER TABLE "note_like" ADD CONSTRAINT "FK_8dc185ad3ae7fc6e49dbf66abef" FOREIGN KEY ("noteId") REFERENCES "note"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "activity" DROP CONSTRAINT "FK_4ec8340b89b02ddf342e770e4ec"`);
        await queryRunner.query(`ALTER TABLE "note_like" DROP CONSTRAINT "FK_8dc185ad3ae7fc6e49dbf66abef"`);
        await queryRunner.query(`ALTER TABLE "note_like" ADD CONSTRAINT "REL_8dc185ad3ae7fc6e49dbf66abe" UNIQUE ("noteId")`);
        await queryRunner.query(`ALTER TABLE "note_like" ADD CONSTRAINT "FK_8dc185ad3ae7fc6e49dbf66abef" FOREIGN KEY ("noteId") REFERENCES "note"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "activity" DROP COLUMN "content"`);
        await queryRunner.query(`ALTER TABLE "activity" DROP COLUMN "apId"`);
        await queryRunner.query(`ALTER TABLE "activity" DROP COLUMN "noteId"`);
