...
export class AvatarBannerAdjustmentsAndAddSensitive1729315452416
	implements MigrationInterface
{
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "user" ADD "avatarAlt" character varying`
		);
		await queryRunner.query(
			`ALTER TABLE "user" ADD "bannerAlt" character varying`
		);
		await queryRunner.query(
