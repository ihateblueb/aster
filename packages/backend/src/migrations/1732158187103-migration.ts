...
export class Migration1732158187103 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bookmark" ("id" character varying NOT NULL, "creatorId" character varying NOT NULL, "userId" character varying, "noteId" character varying, "createdAt" character varying NOT NULL, CONSTRAINT "PK_b7fbf4a865ba38a590bb9239814" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" ADD CONSTRAINT "FK_38b5ffa8154e26c0f3393ac4600" FOREIGN KEY ("creatorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "bookmark" ADD CONSTRAINT "FK_c896ae3f4d0186a1e04f2bc03c6" FOREIGN KEY ("noteId") REFERENCES "note"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "bookmark" DROP CONSTRAINT "FK_c896ae3f4d0186a1e04f2bc03c6"`);
        await queryRunner.query(`ALTER TABLE "bookmark" DROP CONSTRAINT "FK_e389fc192c59bdce0847ef9ef8b"`);
        await queryRunner.query(`ALTER TABLE "bookmark" DROP CONSTRAINT "FK_38b5ffa8154e26c0f3393ac4600"`);
